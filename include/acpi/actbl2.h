...
enum acpi_madt_type {
	...
	ACPI_MADT_TYPE_RESERVED = 23	/* 23 and greater are reserved */
};
...
enum acpi_madt_coreintc_version {
	ACPI_MADT_COREINTC_VERSION_NONE = 0,
	ACPI_MADT_COREINTC_VERSION_V1 = 1,
	ACPI_MADT_COREINTC_VERSION_RESERVED = 2	/* 2 and greater are reserved */
};

enum acpi_madt_liointc_version {
	ACPI_MADT_LIOINTC_VERSION_NONE = 0,
	ACPI_MADT_LIOINTC_VERSION_V1 = 1,
	ACPI_MADT_LIOINTC_VERSION_RESERVED = 2	/* 2 and greater are reserved */
};

enum acpi_madt_eiointc_version {
	ACPI_MADT_EIOINTC_VERSION_NONE = 0,
	ACPI_MADT_EIOINTC_VERSION_V1 = 1,
	ACPI_MADT_EIOINTC_VERSION_RESERVED = 2	/* 2 and greater are reserved */
};

enum acpi_madt_htintc_version {
	ACPI_MADT_HTINTC_VERSION_NONE = 0,
	ACPI_MADT_HTINTC_VERSION_V1 = 1,
	ACPI_MADT_HTINTC_VERSION_RESERVED = 2	/* 2 and greater are reserved */
};

enum acpi_madt_pchintc_version {
	ACPI_MADT_PCHINTC_VERSION_NONE = 0,
	ACPI_MADT_PCHINTC_VERSION_V1 = 1,
	ACPI_MADT_PCHINTC_VERSION_RESERVED = 2	/* 2 and greater are reserved */
};

enum acpi_madt_msintc_version {
	ACPI_MADT_MSINTC_VERSION_NONE = 0,
	ACPI_MADT_MSINTC_VERSION_V1 = 1,
	ACPI_MADT_MSINTC_VERSION_RESERVED = 2	/* 2 and greater are reserved */
};

enum acpi_madt_lpcintc_version {
	ACPI_MADT_LPCINTC_VERSION_NONE = 0,
	ACPI_MADT_LPCINTC_VERSION_V1 = 1,
	ACPI_MADT_LPCINTC_VERSION_RESERVED = 2	/* 2 and greater are reserved */
};

/* Core Interrupt Controller */

struct acpi_madt_coreintc {
	struct acpi_subtable_header header;
	u32 processor_id;
	u32 core_id;
	u32 flags;
