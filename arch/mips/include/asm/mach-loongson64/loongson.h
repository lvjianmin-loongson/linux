...
/* Chip Temperature Interrupt Control High registor of each physical cpu package, PRid >= Loongson-3A */
extern u64 loongson_tempinthi[MAX_PACKAGES];
#define LOONGSON_TEMPINTHI_GET(id) ls64_conf_read64((void *)loongson_tempinthi[id])
#define LOONGSON_TEMPINTHI_SET(val, id) (ls64_conf_write64(val, (volatile void *)loongson_tempinthi[id]))

/* Chip Temperature Interrupt Control Low registor of each physical cpu package, PRid >= Loongson-3A */
extern u64 loongson_tempintlo[MAX_PACKAGES];
#define LOONGSON_TEMPINTLO_GET(id) ls64_conf_read64((void *)loongson_tempintlo[id])
#define LOONGSON_TEMPINTLO_SET(val, id) (ls64_conf_write64(val, (volatile void *)loongson_tempintlo[id]))

/* Chip Temperature Interrupt Status registor of each physical cpu package, PRid >= Loongson-3A */
extern u64 loongson_tempintsta[MAX_PACKAGES];
#define LOONGSON_TEMPINTSTA_GET(id) ls64_conf_read64((void *)loongson_tempintsta[id])
#define LOONGSON_TEMPINTSTA_SET(val, id) (ls64_conf_write64(val, (volatile void *)loongson_tempintsta[id]))

/* Chip Temperature Interrupt Up registor of each physical cpu package, PRid >= Loongson-3A */
extern u64 loongson_tempintup[MAX_PACKAGES];
#define LOONGSON_TEMPINTUP_GET(id) ls64_conf_read64((void *)loongson_tempintup[id])
#define LOONGSON_TEMPINTUP_SET(val, id) (ls64_conf_write64(val, (volatile void *)loongson_tempintup[id]))
