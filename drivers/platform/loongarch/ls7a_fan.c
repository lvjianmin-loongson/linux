			...
			struct loongson_fan_policy *policy, int id)
{
	...
	ls7a_set_fan_level(policy->up_step[fan_up_temp_level[id] - 1].level * 255 / 100, id);
...
static void fan1_adjust(struct work_struct *work)
{
	...
	if (current_temp > fan_up_temp[0])
		ls7a_set_fan_level(fan_policy[0].up_step[fan_up_temp_level[0]].level * 255 / 100, 0);

	if (current_temp < fan_down_temp[0])
		ls7a_set_fan_level(fan_policy[0].down_step[fan_down_temp_level[0]].level * 255 / 100, 0);
...
static void fan2_adjust(struct work_struct *work)
{
	...
	if (current_temp > fan_up_temp[1])
		ls7a_set_fan_level(fan_policy[1].up_step[fan_up_temp_level[1]].level * 255 / 100, 1);

	if (current_temp < fan_down_temp[1])
		ls7a_set_fan_level(fan_policy[1].down_step[fan_down_temp_level[1]].level * 255 / 100, 1);
...
static void fan3_adjust(struct work_struct *work)
{
	...
	if (current_temp > fan_up_temp[2])
		ls7a_set_fan_level(fan_policy[2].up_step[fan_up_temp_level[2]].level * 255 / 100, 2);

	if (current_temp < fan_down_temp[2])
		ls7a_set_fan_level(fan_policy[2].down_step[fan_down_temp_level[2]].level * 255 / 100, 2);
...
static void fan4_adjust(struct work_struct *work)
{
	...
	if (current_temp > fan_up_temp[3])
		ls7a_set_fan_level(fan_policy[3].up_step[fan_up_temp_level[3]].level * 255 / 100, 3);

	if (current_temp < fan_down_temp[3])
		ls7a_set_fan_level(fan_policy[3].down_step[fan_down_temp_level[3]].level * 255 / 100, 3);
