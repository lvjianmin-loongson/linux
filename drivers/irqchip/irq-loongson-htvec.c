...
{
	struct acpi_madt_htintc *htvec_entry;
	struct irq_fwspec fwspec;
	...
	int num_parents = 0;
	u64 base;
	htvec_entry = (struct acpi_madt_htintc *)header;
...
IRQCHIP_ACPI_DECLARE(htvec_v1, ACPI_MADT_TYPE_HTINTC,
		NULL, ACPI_MADT_HTINTC_VERSION_V1,
		htvec_acpi_init_v1);
#endif
