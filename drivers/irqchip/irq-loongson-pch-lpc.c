...
{
	struct acpi_madt_lpcintc *pch_lpc_entry;
	struct fwnode_handle *irq_handle;
	struct irq_fwspec fwspec;
	int parent_irq;
	pch_lpc_entry = (struct acpi_madt_lpcintc *)header;
...
IRQCHIP_ACPI_DECLARE(pch_lpc_v1, ACPI_MADT_TYPE_LPCINTC,
		NULL, ACPI_MADT_LPCINTC_VERSION_V1,
